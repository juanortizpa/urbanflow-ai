...
export const places = [
  {
    ...
    openHours: '24/7', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '7:00-22:00', image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '11:00-22:00', image: 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '20:00-04:00', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '12:00-22:00', image: 'https://images.unsplash.com/photo-1617196034099-89e90ff4d847?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '5:00-23:00', image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '10:00-22:00', image: 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '9:00-18:00', image: 'https://images.unsplash.com/photo-1518998053901-5348d3961a04?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '5:00-18:00', image: 'https://images.unsplash.com/photo-1519996529931-28324d5a630e?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '24/7', image: 'https://images.unsplash.com/photo-1519494026892-80beba2d2506?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '24/7', image: 'https://images.unsplash.com/photo-1553290322-8e430e71e8d3?auto=format&fit=crop&w=400&h=250&q=80',
  ...
  },
  {
    ...
    openHours: '12:00-23:00', image: 'https://images.unsplash.com/photo-1565299624596-054b5214f8ff?auto=format&fit=crop&w=400&h=250&q=80',
...
export const events = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&w=400&h=250&q=80', price: 20, tags: ['music', 'salsa', 'night', 'dancing'],
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1555939594-7d08fd45dc0e?auto=format&fit=crop&w=400&h=250&q=80', price: 0, tags: ['food', 'gastronomy', 'family', 'day'],
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1541625602538-5f66ab6da7de?auto=format&fit=crop&w=400&h=250&q=80', price: 12, tags: ['sports', 'running', 'morning', 'health'],
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&w=400&h=250&q=80', price: 25, tags: ['tech', 'innovation', 'startup', 'AI'],
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?auto=format&fit=crop&w=400&h=250&q=80', price: 30, tags: ['music', 'pacific', 'afro', 'culture'],
  },
];
...
export const alerts = [
  { id: 1, type: 'traffic', severity: 'critical', message: 'Congestión crítica en Av. 6N con Calle 44 — accidente reportado. Desvío por Av. 3N recomendado', time: '3 min', icon: 'alert' },
  { id: 2, type: 'traffic', severity: 'warning', message: 'Hora pico en el Centro Histórico — Carrera 1 con Calle 15 presenta 78% de congestión', time: '8 min', icon: 'traffic' },
  { id: 3, type: 'weather', severity: 'warning', message: 'Lluvia moderada prevista 16:00-18:00 en Cali. Temporada de lluvias activa — lleva paraguas', time: '15 min', icon: 'weather' },
  { id: 4, type: 'event', severity: 'info', message: 'Ciclovia dominical mañana: 40km cerrados desde las 7am. Impacto alto en Av. Roosevelt y Av. Colombia', time: '1 hora', icon: 'event' },
  { id: 5, type: 'recommendation', severity: 'info', message: 'Parque del Perro: afluencia baja ahora mismo. Momento ideal para visitar — espera mínima', time: '20 min', icon: 'star' },
];
